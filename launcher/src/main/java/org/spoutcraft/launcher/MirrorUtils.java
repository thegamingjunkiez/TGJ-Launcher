...
public class MirrorUtils {
	...
	public static final String[]	MIRRORS_URL	= { "https://raw.github.com/thegamingjunkiez/TGJ-Launcher/master/mirrors.yml", "https://raw.github.com/thegamingjunkiez/TGJ-Launcher/master/mirrors.yml" };
	...
	public static boolean isAddressReachable(String url) {
		...
		try {
			...
			if (url.contains("https")) {
				...
				urlConnect.disconnect();
				urlConnect = null;
				return (responseCode == HttpURLConnection.HTTP_OK || responseCode == 302);
			}
		} catch (Exception e) {
		} finally {
