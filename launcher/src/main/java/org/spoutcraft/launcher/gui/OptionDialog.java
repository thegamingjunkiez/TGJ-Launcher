...
public class OptionDialog extends JDialog implements ActionListener {
	...
	public OptionDialog() {
		setTitle("TGJ Launcher Settings");
		...
		buildInfo.setText("TGJ Launcher Build " + Main.build);
		buildInfo.setOpaque(true);
		buildInfo.setForeground(Color.DARK_GRAY);
		buildInfo.setToolTipText("Created by the Spout Development Team and Modified by The Gaming Junkiez Team (Crazyputje). Licensed under the LGPL. Source code is available at www.github.com/SpoutDev");
